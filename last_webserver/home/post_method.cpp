...
std::string resolve_post_path(const Request &obj, const std::string &original_path)
{
    ...
    if (root_pos != std::string::npos)
    {
        ...
        std::cout << "Trying resolved POST path: " << resolved_path << std::endl;
                      ...
                      std::map<std::string, std::string> &form_data, Request &obj)
{
    ...
    std::cout << "POST request for path: " << path << std::endl;
    std::cout << "Using saved post_path: " << obj.post_path << std::endl;
    ...
    std::cout << "Target path after authentication: " << target_path << std::endl;
